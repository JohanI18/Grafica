...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        view = glm::lookAt(glm::vec3(camX, 0.0, camZ), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.1, 0.0));
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            model = glm::translate(model, cubePositions[i]);
            float angle = 20.0f * i;
            if (i % 1 == 0)  // every 3rd iteration (including the first) we set the angle using GLFW's time function.
